...
def navbar():
    left, mid, right = st.columns([2, 5, 2.4])
    with left:
...
def page_home():
    ...
    <div class="mn-hero">
        ...
        <h1 style="margin:0; font-size:2.6rem;">Navigate Hospitals Smarter with AI</h1>
        <p style="font-size:1.05rem; opacity:0.92; max-width:640px;">
